...
public class OrderWin3 extends JFrame {
	...
	public OrderWin3() {
		...
		con.add(tf2);
		tf2.setBounds(120, 50, 85, 40);
		con.add(tf3);
		tf3.setBounds(215, 50, 80, 40);
		
		con.add(btn1);
		btn1.setBounds(30, 100, 80, 40);
		con.add(btn2);
		btn2.setBounds(120, 100, 85, 40);
		con.add(btn3);
		btn3.setBounds(215, 100, 80, 40);
		con.add(btn4);
		btn4.setBounds(305, 100, 80, 40);
		...
		btn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				sql = String.format("insert into order0729(order_id, product, quantity) values('%s', '%s' ,%s)",orderId, product, quantity);
				try {
		...
		btn3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				sql = String.format("Update order0729 set product = '%s', quantity = '%s' where order_Id = '%s';", product, quantity, orderId);
				try {
					stmt.executeUpdate(sql);
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
